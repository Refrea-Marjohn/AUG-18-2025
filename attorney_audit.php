...
<body>
    ...
    <div class="main-content">
        <!-- Custom Header for Audit Trail -->
        <div class="header">
            <div class="header-title">
                <h1>Audit Trail</h1>
                <p>Complete tracking of all your professional activities and case management actions</p>
            </div>
            <div class="user-info">
                <img src="<?= htmlspecialchars($profile_image) ?>" alt="Attorney" style="object-fit:cover;width:40px;height:40px;border-radius:50%;border:2px solid var(--primary-color);">
                <div class="user-details">
                    <h3><?= htmlspecialchars($attorney_name) ?></h3>
                    <p>Attorney at Law</p>
                </div>
            </div>
        </div>

...
while ($row = $res->fetch_assoc()) {
    ...
    if (!$img || !file_exists($img)) $img = 'images/logo.jpg';
...
if (isset($_POST['action']) && $_POST['action'] === 'fetch_messages') {
    ...
    if (!$admin_img || !file_exists($admin_img)) $admin_img = 'images/logo.jpg';
    ...
    if (!$client_img || !file_exists($client_img)) $client_img = 'images/logo.jpg';
...
if (!$admin_profile_image || !file_exists($admin_profile_image)) {
    $admin_profile_image = 'images/logo.jpg';
}
?>
<!DOCTYPE html>
<html lang="en">

        ...
        <div class="modal-content">
            ...
            <form>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone_number" maxlength="11" pattern="[0-9]{11}" required placeholder="Enter 11-digit phone number" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 11)" onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                </div>
                <div class="form-group">
                    <label>Role</label>
                    <select required>

...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email)) {
        ...
        $errors[] = "Email address must be a valid @gmail.com address only";
    }
        ...
        if ($stmt->execute()) {
            ...
            if ($user_type === 'employee' || $user_type === 'attorney') {
                ...
                if ($email_sent) {
                    ...
                    $_SESSION['success_message'] = "User '$name' has been successfully created as $user_type! However, there was an issue sending the password email.";
                }
            } else {
